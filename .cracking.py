...
--------------------------------------------------
 Author      : Shahzada Sohrab Jan
 GitHub      : https://github.com/SHAHZADASOHRABJAN420
 YouTube     : Termux Master
 Telegram    : https://t.me/ShAhZaDa_SoHrAb_420
 Facebook    : https://www.facebook.com/ShAhZaDa.SoHrAb.420
--------------------------------------------------"""
back = 0
threads = []
successful = []
...
def menu2_menu():
    ...
    if m2m =="":
        ...
        time.sleep(1)
        os.system('python2 king_jalalbad.py')
    else:
        print "[!] Wrong Input."
        menu2_menu()
